...
public class HexManager : MonoBehaviour
{
    ...
    private IEnumerator RotateFinish()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            if (CheckNearbyHexs(hexSelect.GetChild(i).gameObject))
            {
                success = true;
            }
        }
    ...
    void LeaveHexSelect()
    {
        if (hexSelect.childCount > 0)
        {
            ...
            hexSelect.position = new Vector3(-2, 0, -0.1f);
        }
    }
    ...
    private IEnumerator CheckItAll()
    {
        ...
        for (int x = 0; x < xGrid; x++)
        {
            for (int y = 0; y < yGrid; y++)
            {
                if(CheckNearbyHexs(hexagons[x, y]))
                {
                    success = true;
                }
            }
    ...
    bool CheckNearbyHexs(GameObject hexToCheck)
    {
        bool success = false;
        ...
        Color color1 = hexToCheck.GetComponent<Renderer>().material.color;
        Color color2;
        ...
        if (hexX % 2 == 0)
        {
            if(hexX != xGrid - 1)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexX != xGrid - 1 && hexY != yGrid - 1 && color1.Equals(color2))
                    {
                    ...
                    else if (hexY != 0 && color1.Equals(color3))
                    {
            ...
            if(hexX != xGrid - 1 && hexY != yGrid - 1)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexX != xGrid - 1 && color1.Equals(color2))
                    {
                    ...
                    else if (hexY != yGrid - 1 && color1.Equals(color3))
                    {
            ...
            if(hexY != yGrid - 1)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    else if (hexX != 0 && hexY != yGrid - 1 && color1.Equals(color3))
                    {
            ...
            if(hexX != 0 && hexY != yGrid - 1)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexY != yGrid - 1 && color1.Equals(color2))
                    {
                    ...
                    else if (hexX != 0 && color1.Equals(color3))
                    {
            ...
            if(hexX != 0)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexX != 0 && hexY != yGrid - 1 && color1.Equals(color2))
                    {
        ...
        else
        {
            ...
            if(hexX != xGrid - 1)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexX != xGrid - 1 && hexY != 0 && color1.Equals(color2))
                    {
            ...
            if(hexX != 0)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    else if (hexX != 0 && hexY != 0 && color1.Equals(color3))
                    {
            ...
            if(hexY != 0)
            {
                ...
                if (color1.Equals(color2))
                {
                    ...
                    if (hexX != 0 && hexY != 0 && color1.Equals(color2))
                    {
                    ...
                    else if (hexX != xGrid - 1 && hexY != 0 && color1.Equals(color3))
                    {
    ...
    void SelectHex()
    {
        ...
        switch (touch.phase)
        {
            ...
            case TouchPhase.Moved:
                ...
                if (direction.magnitude > 100 && !rotate)
                {
                    Debug.Log("rotate");
